package Garbagio::Fantastico::Smellier;
use Moo;
use MooX::Types::MooseLike::Base qw(:all);

=head1 NAME

Garbagio::Fantastico::Smellier - The great new Garbagio::Fantastico::Smellier! TODO revise this
...
=head1 SYNOPSIS
   ...
   use Garbagio::Fantastico::Smellier;
   my $obj = Garbagio::Fantastico::Smellier->new({ ...  });

   # TODO expand on this

=head1 DESCRIPTION

Garbagio::Fantastico::Smellier is a module that ...
...
Creates a new Garbagio::Fantastico::Smellier object.
