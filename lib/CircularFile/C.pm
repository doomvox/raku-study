...
CircularFile::C - TODO Perl extension for blah blah blah

=head1 SYNOPSIS

   use CircularFile::C ':all';

   TODO

=head1 DESCRIPTION

TODO  Stub documentation for CircularFile::C,
...
BEGIN {
 ...
 qw(
  ...
  # The above allows declaration	use CircularFile::C ':all';
