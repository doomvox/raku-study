...
CircularFile::B - TODO Perl extension for blah blah blah

=head1 SYNOPSIS

   use CircularFile::B ':all';

   TODO

=head1 DESCRIPTION

TODO  Stub documentation for CircularFile::B,
...
BEGIN {
 ...
 qw(
  ...
  # The above allows declaration	use CircularFile::B ':all';
