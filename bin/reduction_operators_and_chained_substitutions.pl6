...
say "===";
{
    ...
    my $caesar = "Gallia est omnis divisa in partes tres";
    my $trans1 = do given $caesar {
        { say $caesar, ' ', $_; s/Gallia/Gaul/ };
        { say $caesar, ' ', $_; s/est/is/ };
        { say $caesar, ' ', $_; s/omnis/a_whole/ };
        { say $caesar, ' ', $_; s/divisa/divided/ };
        { say $caesar, ' ', $_; s/in/into/ };
        { say $caesar, ' ', $_; s/partes/parts/ };
        { say $caesar, ' ', $_; s/tres/three/ } 
    };
    put $caesar;  # Gallia est omnis divisa in partes tres
    put $trans1;  # Gaul is a_whole divided into parts three
}
