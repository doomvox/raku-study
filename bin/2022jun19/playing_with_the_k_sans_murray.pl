#!/usr/bin/env perl
# playing_with_the_k_sans_murray.pl                   doom@kzsu.stanford.edu
#                                                     19 Jun 2022

=head1 NAME

playing_with_the_k_sans_murray.pl - (( TODO insert brief description ))

=head1 SYNOPSIS

  playing_with_the_k_sans_murray.pl -[options] [arguments]

  TODO

=head1 DESCRIPTION

B<playing_with_the_k_sans_murray.pl> is a script which
...
# perl5 perl5 perl5
{
  my $str = "prefix and some following stuff";
