...
#+END_SRC 
***** note: the \h+ requires leading whitespace in front of comment
...
***** fixes my made a mistake: s/cover/swallow/
***** expanding "w/us" to "with us" looks like a later improverment
