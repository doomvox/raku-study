- [meeting notes May 16, 2021](#org5498494)
  - [subjects discussed](#org6cfb1d8)
    - [richard hainsworth reports in on the documentation system work](#orgca1f107)
    - [raku features for writing find/grep variants (joe brenner)](#org92dd54b)
    - [bruce gray discussed a rosettacode entry](#orgbdec3e9)
    - [testing for all elements undefined](#org9fc3a77)
    - [david christensen talked about a few debian sysadmin issues](#orgb2a412f)
    - [higher-order programming as a substitute for macros (perl5)  (david christensen)](#org21b8b24)
    - [william michels asks about one-liners to strip "soft hypens"](#org35e897e)
    - [bill found them in this page, notably written by hyphenation nerds:](#org5a8d7bc)
    - [William Michels : Q. Should Raku create pre-defined (so-called) "Grey-space" character classes?](#org1d280bd)
    - [bruce gray supplies some requested one-liners:](#org9fbc752)
    - [he also makes the point you can do a chained operation to strip whitespace as well](#org0ead164)
    - [raku also lets you define custom character classes extending pre-defined ones](#org48a632f)
  - [ongoing](#orgb67501b)
    - [programming in the large (david christensen)](#org4bf29ad)
    - [raku idioms](#org9257e36)
  - [appendix: the usual links](#org69ed0c5)
    - [code examples](#orgbc62d6a)
    - [meeting notes (material from this file)](#orge25d30a)
    - [SF Perl page, has links to mailing list](#org4a6a539)
    - [perl6-users mailing list archive](#org4ac1962)
  - [bits](#org5a9c0dc)
    - [bg summarizes](#org842d0f0)
    - [announced: going to skip next sunday, thinking about going with every-other week format](#orgad19487)
    - [perl5 cpan module  Filesys::ZFS, david christensen says "not complete"](#orgbdcf395)
    - [steve yegge, a fascinating perl hater:](#orgc8f0451)
    - [a defense of perl/raku talk](#org772eb90)
