- [meeting notes May 16, 2021](#org0e29614)
  - [subjects discussed](#orgb443f07)
    - [richard hainsworth reports in on the documentation system work](#org5986e3b)
    - [raku features for writing find/grep variants (joe brenner)](#org682730b)
    - [bruce gray discussed a rosettacode entry](#org3699337)
    - [testing for all elements undefined](#org1249ee5)
    - [david christensen talked about a few debian sysadmin issues](#orgb950eca)
    - [higher-order programming as a substitute for macros (perl5)  (david christensen)](#orgf663b5a)
    - [william michels asks about one-liners to strip "soft hypens"](#org6fdaf15)
    - [bill found them in this page, notably written by hyphenation nerds:](#org6de08ff)
    - [William Michels : Q. Should Raku create pre-defined (so-called) "Grey-space" character classes?](#orga63b323)
    - [bruce gray supplies some requested one-liners:](#orgff9200c)
    - [he also makes the point you can do a chained operation to strip whitespace as well](#orgbdeaa59)
    - [raku also lets you define custom character classes extending pre-defined ones](#org9ba9c3d)
  - [ongoing](#orge2d0994)
    - [programming in the large (david christensen)](#orgeb52305)
    - [raku idioms](#org1ca80ad)
  - [appendix: the usual links](#orgd555e50)
    - [code examples](#org729cef7)
    - [meeting notes (material from this file)](#org548c492)
    - [SF Perl page, has links to mailing list](#orgcb6e0b6)
    - [perl6-users mailing list archive](#org2086585)
  - [bits](#org9b120d0)
    - [fosdem talk, programming<sub>lang</sub><sub>for</sub><sub>free</sub><sub>software</sub>](#org54bf1e0)
    - [announcement: going to skip next sunday, thinking about going with every-other week format](#orgf2824c0)
    - [perl5 cpan module  Filesys::ZFS, david christensen says "not complete"](#org5d56502)
    - [steve yegge, a fascinating perl hater:](#orgcd104cc)
    - [a defense of perl/raku talk](#org2cf24bb)
