...
it, storing the numerator and denominator as two Int objects. "

***** "A FatRat is more infectious than a Rat, so many math operations with a
FatRat will produce another FatRat, preserving all of the available
precision."
