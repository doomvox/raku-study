...
having trouble with the embedded pattern-match modifiers:
...
being done: leaving a semi-broken feature lying around
(and then when someone trips over it imply they're
dumb for trying to use it).
