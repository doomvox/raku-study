...
***** man perlstyle: 
"... use underscores to separate words in longer identifiers. It
...
****** There's nothing fundamentally interesting about this debate
****** Except the fact that it exists.

**** my new band is named: "keyboard noise people"
