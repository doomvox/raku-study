...
***** maybe: an "is-early" check, remove a test if needed, make it easily identifiable (?)
***** maybe: need cultural change, don't revise system tools to just make it prettier ('modernize')
