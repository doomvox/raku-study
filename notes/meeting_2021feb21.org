...
**** looks very good, very far along, additional features for html effects and image includes
***** one goal is to extend pod6 so that it's more useful for website generation
** announcements
...
**** TODO say @numbers;     # [Set(foah sex tew)]  ## BUG?  Bruce Gray thinks so.
