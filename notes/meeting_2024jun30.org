...
****** here the subject his the Damian perl module Multi::Dispatch
...
******** examples are perl: steal them and rakuize them?
******* some principles are positive (reasons to promote), some read as negative
...
********* I tried to add one: the pull request has been ignored for years
