...
**** htmx+Air+Red+Cro
***** Marton:
****** Red is the "big Raku ORM", Cro is the "big Raku web Framework", Air is his own thing (not sure what it does) and htmx is some sort of common html templating system
